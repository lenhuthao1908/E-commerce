                ...
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    ...
                    <c:if test="${sessionScope.acc.isAdmin != 1 }">
                        <c:if test="${sessionScope.acc.isSell != 1 }">
                            <li class="list-group-item clearfix"><a href="shop-mybill.jsp"><i
                ...
                <div class="content-page">
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <p><%= acc.getWard()%> / <%= acc.getDistrict()%> / <%= acc.getCity()%>
                                </p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-primary"><a href="loadmyaccount?aid=<%= acc.getId() %>"
                                                               style="color: #FFF; text-decoration: none;">Edit
                                Account</a></button>
                        </div>
                        <%
                        %>
