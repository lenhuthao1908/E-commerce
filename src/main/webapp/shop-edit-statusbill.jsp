        ...
        <form action="editstatusbill" method="post">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Bill_id</label>
                    <input value="<%= bill.getBill_id() %>" name="billid" type="text" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
                    <label>Account_id</label>
                    <input value="<%= bill.getAcc_id() %>" name="accid" type="text" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
                    <label>Fullname</label>
                    <input value="<%= bill.getFullname() %>" name="namebill" type="text" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
