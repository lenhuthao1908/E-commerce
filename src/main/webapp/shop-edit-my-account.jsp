        ...
        <div class="row margin-bottom-40">
            ...
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    <li class="list-group-item clearfix active"><a href="shop-account.jsp"><i
                    ...
                    <li class="list-group-item clearfix"><a href="shop-mybill.jsp"><i class="fa fa-angle-right"></i> My
                        Bill</a></li>
                    ...
                    <form action="editmyaccount" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="${acc.user}" name="user" type="text" class="form-control" readonly
                                       required>
                            </div>
                            <div class="form-group">
                                <label>Fullname</label>
                                <input value="${acc.fullname}" name="fullname" type="text" class="form-control"
                                       required>
                            </div>
                            <div class="form-group">
                                <label>Phone</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-group" id="district" name="district">
                                    <option class="form-control" value="${acc.district}"
                                            selected>${acc.district}</option>
                                </select>
                                <br>
                        ...
                        <div class="modal-footer">
                            <a href="shop-account.jsp"><input type="button" class="btn btn-close" data-dismiss="modal"
                                                              value="Cancel"></a>
