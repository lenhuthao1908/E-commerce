        ...
        <div class="row margin-bottom-40">
            ...
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    <li class="list-group-item clearfix"><a href="shop-account.jsp"><i class="fa fa-angle-right"></i> My
                        account</a></li>
                    <li class="list-group-item clearfix"><a href="shop-mychangepassword.jsp"><i
                            class="fa fa-angle-right"></i> Restore Password</a></li>
                    <li class="list-group-item clearfix active"><a href="shop-mybill.jsp"><i
                            class="fa fa-angle-right"></i> My Bill</a></li>
                ...
                <div class="content-page">
                    <table>
                        ...
                        <tr style="background: whitesmoke;">
                            <td class="font" colspan="1"><%= bill.getPhone1()%> <br> <%= bill.getPhone2()%>
                            </td>
                            <td class="font" colspan="3"><%= bill.getCity()%> <br> <%= bill.getDistrict()%>
                                <br> <%= bill.getWard()%>
                            </td>
                            <td class="font" colspan="1"><%= bill.getDate()%>
                            </td>
                            <td class="font" colspan="2"><%= bill.getDesbill()%>
                            </td>
                            <td class="font" colspan="1"><%= bill.getTotal() %>
                            </td>
                        ...
                        <tr style="">
                            ...
                            <td class="goods-page-image" colspan="2">
                                <a href="detail?pid=<%= p.getId()%>"><img src="image/<%= p.getImage()%>"
                                                                          alt="Product image"></a>
                            </td>
                            <td colspan="1"><%= p.getId()%>
                            </td>
                            <td colspan="3"><%= p.getName()%>
                            </td>
                            <td colspan="1"><%= b.getQuantity()%>
                            </td>
                            <td colspan="1"><%= p.getPrice()%>
                            </td>
