            ...
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    <li class="list-group-item clearfix"><a href="shop-account.jsp"><i class="fa fa-angle-right"></i> My
                        account</a></li>
                    <li class="list-group-item clearfix active"><a href="shop-mychangepassword.jsp"><i
                    ...
                    <form action="changepassword" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input value="${sessionScope.acc.user}" name="user" type="text" class="form-control"
                                       readonly required>
                            </div>
                            <div class="form-group">
                                <label>Old Password</label> <br>
                                <input name="oldpass" type="password" class="form-control"
                                       placeholder="Enter a your password" required>
                            </div>
                            <div class="form-group">
