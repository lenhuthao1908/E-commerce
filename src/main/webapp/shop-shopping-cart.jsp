        ...
        <div class="row margin-bottom-40">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="goods-page">
                    ...
                    <div class="goods-data clearfix">
                            ...
                            <table summary="Shopping cart">
                                ...
                                <tr>
                                    ...
                                    <td class="goods-page-id">
                                        <strong><%=cart.getCid().getId()%>
                                        </strong>
                                    </td>
                                    <td class="goods-page-image">
                                        <a href="detail?pid=<%=cart.getCid().getId()%>"><img
                                                src="image/<%=cart.getCid().getImage()%>" alt="Berry Lace Dress"></a>
                                    </td>
                                    <td class="goods-page-description">
                                        <h3><a href="detail?pid=<%=cart.getCid().getId()%>"><%=cart.getCid().getName()%>
                                        </a></h3>
                                        <p><strong><%=cart.getCid().getTitle()%>
                                        </strong></p>
                                        <!--<em><%=cart.getCid().getDescription()%></em><br>-->
                                        <p>SIZE: <strong><%= cart.getSize()%>
                                        </strong></p><a href=""><i class="bi bi-pen"></i></a>
                                    </td>
                                    <td class="del-goods-col">
                                        <a class="" href="delcart?action=DelCart&code=<%= cart.getCid().getId()%>"><i
                                                class="fa fa-minus"></i></a>
                                    </td>
                                    <td class="goods-page-quantity">
                                        <strong><%=cart.getQuantity()%>
                                        </strong>
                                    </td>
                                    <td class="del-goods-col">
                                        <a class="" href="addcart?action=AddToCart&code=<%= cart.getCid().getId()%>"><i
                                                class="fa fa-plus"></i></a>
                                    </td>
                                    <td class="goods-page-price">
                                        <strong><%=cart.getCid().getPrice()%>
                                        </strong>
                                    </td>
                                    <td class="goods-page-total" colspan="2">
                                        <strong><%=cart.getCid().getPrice() * cart.getQuantity()%>
                                        </strong>
                                    </td>
                                    <td class="del-goods-col">
                        ...
                        <div class="shopping-total">
                            <ul>
                                ...
                                <li>
                                    <em>Shipping cost</em>
                                    <strong class="price"><%= ship%>
                                    </strong>
                                </li>

                                <li class="shopping-total-price">
                                    <em>Total</em>
                                    <strong class="price"><%= total + ship%>
                                    </strong>
                                </li>
                    ...
                    <button class="btn btn-default" type="submit"><a href="index"
                                                                     style="text-decoration: none; color: #FFF;">Continue
                    ...
                    <a href="checkout">
                        <button data-toggle="modal" class="btn btn-primary">Checkout <i class="fa fa-check"></i>
                        </button>
                    </a>
                </div>
            </div>
