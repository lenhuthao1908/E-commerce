                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="product-main-image">
                                <img src="image/${detail.image}" alt="Product detail" class="img-responsive"
                                     data-BigImgsrc="${detail.image}">
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-5">
                            ...
                            <div class="price-availability-block clearfix">
                                ...
                                <div class="availability">
                                    Brand: <strong><%= p.getTitle()%>
                                </strong> <br/>
                                    Product ID: <strong><%= p.getId()%>
                                </strong> <br/>
                                    Quantity: <strong><%= p.getQuantity()%>
                                </strong>
                                </div>
                            </div>
                            <form action="addcart?action=AddToCartOndetail" method="post">
                                ...
                                <div class="product-page-cart">
                                    ...
                                    <div class="product-quantity">
                                        <input name="quantity" id="product-quantity" type="text" value="1" readonly
                                               class="form-control input-sm"/>
                                    </div>
                                    <button name="code" type="submit" value="${detail.id}"
                                            class="btn btn-default add2cart btn-primary">Add to cart
                                    </button>
                                    <%
                                    } else {
                                    %>
                            ...
                            %>
                            <div class="review">
                                <div class="rateit" data-rateit-value="<%= totalstar%>" data-rateit-ispreset="true"
                                     data-rateit-readonly="true"></div>
                                <a href="#Reviews"><%= list.size()%> reviews</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
                                    href="#comment">Write a review</a>
                            </div>
                            ...
                            <div class="tab-pane fade in active" id="Reviews">
                                ...
                                <div class="review-item clearfix">
                                    <div class="review-item-submitted">
                                        <a href="delcomment?cm_id=<%= comment.getComment_id()%>&pid=<%= comment.getComment_pid()%>"><i
                                                class="del-goods" title="Delete"></i></a>
                                    </div>
                                    <div class="review-item-submitted">
                                        <strong><%= comment.getComment_name()%>
                                        </strong>
                                        <div class="rateit" data-rateit-value="<%= comment.getComment_star()%>"
                                    ...
                                    <div class="review-item-content">
                                        <p><%= comment.getComment_descrsiption()%>
                                        </p>
                                    </div>
                                </div>
                                <%
                                ...
                                <form onsubmit.prenven action="addcomment" id="comment">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="${sessionScope.acc.user}"
                                               name="comment_user" readonly>
                                    </div>
                                    <div class="form-group" style="display: none;">
                                        <input type="text" class="form-control" value="${sessionScope.acc.id}"
                                               name="comment_aid" readonly>
                                        <input type="text" class="form-control" value="${detail.id}" name="comment_pid"
                                               readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Comment</label>
                                        <textarea name="comment_des" class="form-control" rows="8"
                                                  id="review"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Rating</label>
