                            ...
                            <table summary="Manager Category">
                                ...
                                <tr>
                                    <td class="goods-page-cid">
                                        <strong><%= category.getCid()%>
                                        </strong>
                                    </td>
                                    <td class="goods-page-cname">
                                        <strong><%= category.getCname()%>
                                        </strong>
                                    </td>

                                    <td class="edit-goods-col">
                                        <a href="loadcc?cid=<%= category.getCid()%>" class="edit" data-toggle="modal"><i
                                                class="fa fa-pencil"></i></a>
                                    </td>
                                    <td class="del-goods-col">
                                        <a href="delcc?cid=<%= category.getCid()%>" data-toggle="modal"><i
