...
<div class="container">
    ...
    <div class="login form">
        ...
        <form action="login" method="post">
            <input style="height: 45px; padding: 0 10px" name="user" type="text" placeholder="Enter your account"
                   required>
            <input style="height: 45px; padding: 0 10px" name="pass" type="password" placeholder="Enter your password"
                   required>
    ...
    <div class="registration form">
        ...
        <form action="signup" method="post">
            <input style="height: 30px; padding: 0 10px" class="form-control " name="user" type="text"
                   placeholder="Enter your account" required>
            <input style="height: 30px; padding: 0 10px" class="form-control " name="pass" type="password"
                   placeholder="Create a password" required>
            <input style="height: 30px; padding: 0 10px" class="form-control " name="repass" type="password"
                   placeholder="Confirm your password" required>
            <input style="height: 30px; padding: 0 10px" class="form-control " name="fullname" type="text"
                   placeholder="Enter your fullname" required>
            <input style="height: 30px; padding: 0 10px" class="form-control " name="phone" type="tel"
                   placeholder="Enter your phone" required>
            <input style="height: 30px; padding: 0 10px" class="form-control " name="email" type="email"
