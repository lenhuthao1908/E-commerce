    ...
    <div class="container">
        ...
        <form action="purchase" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Account</label>
                    <input value="${sessionScope.acc.user}" name="user" type="text" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
                    <label>Email</label>
                    <input value="${sessionScope.acc.email}" name="email" type="email" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
                    <label>Phone 1</label>
                    <input value="${sessionScope.acc.phone}" name="phone1" type="tel" class="form-control" readonly
                           required>
                </div>
                <div class="form-group">
                    <label>Phone 2</label>
                    <input name="phone2" type="tel" class="form-control" placeholder="Enter your phone delivery"
                           required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="desbill" rows="3" class="form-control"
                ...
                <div class="modal-body">
                    <table class="col-md-12 col-sm-12">
                        ...
                        %>
                        <tr>
                            <td class="goods-page-name" colspan="2"><%=cart.getCid().getName()%>
                            </td>
                            <td class="goods-page-quantity" colspan="1"><%=cart.getQuantity()%>
                            </td>
                            <td class="goods-page-price" colspan="1"><%=cart.getCid().getPrice()%>
                            </td>
                        </tr>
                        <%
                            }
                    ...
                    <table class="col-md-12 col-sm-12">
                        <tr>
                            ...
                            <th class="goods-page-price" colspan="1"><%= totaldetail%>
                            </th>
                        </tr>
                        <tr>
                            <th class="goods-page-name" colspan="2">SHIP</th>
                            <th class="goods-page-quantity" colspan="1"></th>
                            <th class="goods-page-price" colspan="1"><%= ship%>
                            </th>
                        </tr>
                        <tr>
                            <th class="goods-page-name" colspan="2">TOTAL</th>
                            <th class="goods-page-quantity" colspan="1"></th>
                            <th class="goods-page-price" colspan="1"><%= total%>
                            </th>
                        </tr>
                ...
                <div class="modal-footer">
                    <a href="shop-shopping-cart.jsp"><input type="button" class="btn btn-close" data-dismiss="modal"
                                                            value="Cancel" style="color: #000;"></a>
