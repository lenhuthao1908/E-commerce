                    ...
                    <c:forEach items="${p5l}" var="o">
                        <div class="product-item" style="width: 250px; height: 400px">
                            <div class="pi-img-wrapper">
                                <img src="image/${o.image}" style="height: 300px" class="img-responsive"
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="assets/pages/img/index-sliders/ads1.png" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="assets/pages/img/index-sliders/ads2.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="assets/pages/img/index-sliders/ads3.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                        </div>
                    </div>
