    ...
    <div class="container">
        ...
        <div class="row margin-bottom-40">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <button href="#addEmployeeModal" data-toggle="modal" class="btn btn-primary margin-bottom-10"><i
                            ...
                            <table summary="Manager Product">
                                ...
                                <tr>
                                    <td class="goods-page-id">
                                        <strong><%= product.getId()%>
                                        </strong>
                                    </td>
                                    <td class="goods-page-image">
                                        <a href="image/<%= product.getImage()%>"><img
                                                src="image/<%= product.getImage()%>" alt="Berry Lace Dress"></a>
                                    </td>
                                    ...
                                    <td class="goods-page-price">
                                        <strong><%= product.getPrice()%>
                                        </strong>
                                    </td>
                                    <td>
                                        <h3 class="text-primary" style="font-weight: 1000;"><%= product.getQuantity()%>
                                        </h3>
                                    </td>
                                    <td class="edit-goods-col">
                                        <a href="loadproduct?pid=<%= product.getId()%>" class="edit"
                                           data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                    </td>
                                    <td class="del-goods-col">
                                        <a href="delete?pid=<%= product.getId()%>" data-toggle="modal"><i
                                                class="del-goods" data-toggle="tooltip" title="Delete"></i></a>
                                    </td>
                                </tr>
                                <%
                                    }
