<%-- 
    Document   : shop-edit-size
    Created on : Apr 7, 2023, 8:21:57 PM
    Author     : nhuth
--%>
                    ...
                    <form action="editsize" method="post">
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                <label>SID</label>
                                <input value="${detailSize.sid}" name="sid" type="text" class="form-control" readonly required>
                            </div>
                            <div class="form-group">
                                <label>SNAME</label>
                                <input value="${detailSize.sname}" name="sname" type="text" class="form-control"  required>
                            </div>
                        </div>
