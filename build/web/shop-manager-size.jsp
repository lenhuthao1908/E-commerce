<%-- 
    Document   : shop-manager-size
    Created on : Apr 7, 2023, 5:43:16 PM
    Author     : nhuth
--%>
                ...
                <div class="container">
                    ...
                    <div class="row margin-bottom-40">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <h1>Manager Size</h1>
                            <button href="#addEmployeeModal"  data-toggle="modal" class="btn btn-primary margin-bottom-10" ><i class="fa fa-plus"></i> Add Size</button>
                                    ...
                                    <div class="table-wrapper-responsive table-container-mh800">
                                        ...
                                        <tr>
                                            ...
                                            <td class="goods-page-cname">
                                                <strong><%= s.getSname()%></strong>
                                            </td>

                                            <td class="edit-goods-col">
                                                <a href="loadsize?sid=<%= s.getSid()%>"  class="edit" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                            </td> 
                                            <td class="del-goods-col">
                                                <a href="delsize?sid=<%= s.getSid()%>"  data-toggle="modal"><i class="del-goods" data-toggle="tooltip" title="Delete"></i></a>
                                            </td>
